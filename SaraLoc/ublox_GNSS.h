...
public:
	...
	bool sendUBX(unsigned char* msg, uint32_t size);
...
#define FIX_TIMEOUT		60000
	...
	// UBX Checksum
	bool crc(unsigned char* msg, uint32_t size);

	unsigned char _saveCFG[21] = { 0xB5, 0x62, 0x06, 0x09, 0x0D, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0x00,
